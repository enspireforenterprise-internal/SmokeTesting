...
def Run_Test_Case():
    ...
    try:
        ...
        common_page.navigate_to_site(driver,"https://www.avalanchefloorcoveringsco.com/contact")
        ...
        login_page.validates_form_in_site_admin(driver, returned_email,"IDG")
        login_page.user_Login_to_yodle(driver)
        login_page.validates_form_in_centermark(driver, locationNumber, locationName, returned_email,"IDG")
