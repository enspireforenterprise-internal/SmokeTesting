...
class Login():
    ...
    def user_Login_to_siteadmin(self, driver):
        try:
            ...
            copyright_element = self.common_page.find_my_clickable_element((By.XPATH, "//footer//*[contains(text(),'©')]"))
            time.sleep(1)
    ...
    def validates_form_in_centermark(self, driver, LocNumber, LocName, returned_email_address,brand_name):
        ...
        if LocName in search_result_element.text:
            ...
            for RecentEmail in RecentEmails:
                ...
                if returned_email_address in email_text:
                    ...
                    driver.get_screenshot_as_file(f"{brand_name}_YL_Leads.png")
                    break

    def validates_form_in_site_admin(self, driver, email_address,brand_name):
        ...
        if len(options) > 1:
            ...
            for row in rows:
                ...
                if current_date in date_content and "Test Lead" in test_lead_content:
                    ...
                    driver.get_screenshot_as_file(f"{brand_name}_CASH_Leads.png")
                    break
                else:
                    print("Lead not found in CASH")
